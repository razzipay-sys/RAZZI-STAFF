        ...
        <Card className="border border-white/10 bg-white/5 backdrop-blur-xl shadow-2xl">
          ...
          <CardContent className="px-6 pb-6 space-y-4">
            ...
            {mode === 'forgot' && resetSent ? (
              <div className="rounded-lg bg-emerald-500/10 border border-emerald-500/20 px-4 py-3 text-sm text-emerald-400 text-center">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="text-right">
                      <button
                        ...
                        className="text-xs text-[#20b2aa] hover:text-[#20b2aa]/80 transition-colors"
                      >
                        Forgot password?
                      </button>
                    </div>
